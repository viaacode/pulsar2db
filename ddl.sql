...
CREATE TABLE public.sipin_sips (
	...
	cp_id text NOT NULL, -- The ID for this CP within meemoo. Also known as OR-id.
	...
	md5_hash_essence_sidecar text NULL, -- MD5 hash as was delivered in the sidecar.
...
COMMENT ON COLUMN public.sipin_sips.md5_hash_essence_sidecar IS 'MD5 hash as was delivered in the sidecar.';